...
export function HistoricalPhotoShowcase() {
  ...
  // Parallax transforms for each photo
              ...
              >
                <div className="relative overflow-hidden rounded-lg bg-gray-900">
                  <motion.img
                    src={photo.src}
                    alt={photo.title}
                    className="w-full h-[400px] object-cover filter grayscale hover:grayscale-0 transition-all duration-700"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    <div className="flex items-end justify-between">
                      <div>
                        <p className="text-primary text-sm font-semibold mb-2">{photo.year}</p>
